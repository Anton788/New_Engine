...
double J_5_5 (double y[34]) {
    return -2.5*y[18] + 4.40312283019187e-6*y[4]*y[5]/(0.00411522633744856*y[5] + 1)**2 - 0.26*y[4]/(y[5] + 243.0);
}
...
double J_5_6 (double y[34]) {
    return -4.40312283019187e-6*y[4]*y[5]/(0.00411522633744856*y[5] + 1)**2 + 0.26*y[4]/(y[5] + 243.0);
}
...
double J_9_9 (double y[34]) {
    return -78.3*y[18] + 5.67901234567901e-6*y[4]*y[9]/(0.00222222222222222*y[9] + 1)**2 - 1.15*y[4]/(y[9] + 450.0);
}
...
double J_9_10 (double y[34]) {
    return -5.67901234567901e-6*y[4]*y[9]/(0.00222222222222222*y[9] + 1)**2 + 1.15*y[4]/(y[9] + 450.0);
}
...
double J_11_11 (double y[34]) {
    return 0.00209876543209877*y[11]*y[23]/(0.0158730158730159*y[11] + 1)**2 - 8.33*y[23]/(y[11] + 63.0);
}
...
double J_15_15 (double y[34]) {
    return 1.9935920256319e-5*y[15]*y[28]/(0.000943396226415094*y[15] + 1)**2 - 22.4*y[28]/(y[15] + 1060.0);
}
...
double J_14_17 (double y[34]) {
    return 0.37*y[14]*y[17]/(y[14] + 1)**2 - 0.37*y[17]/(y[14] + 1);
}
...
double J_19_19 (double y[34]) {
    return 4.1649312786339e-5*y[14]*y[19]/(0.00680272108843537*y[19] + 1)**2 - 0.9*y[14]/(y[19] + 147.0) - 3.225*y[18];
}
...
double J_19_20 (double y[34]) {
    return -4.1649312786339e-5*y[14]*y[19]/(0.00680272108843537*y[19] + 1)**2 + 0.9*y[14]/(y[19] + 147.0);
}
...
double J_21_21 (double y[34]) {
    return 0.9*y[16]*y[21]/(y[21] + 200)**2 - 0.9*y[16]/(y[21] + 200);
}
...
double J_21_22 (double y[34]) {
    return -5.75e-5*y[12]*y[21]/(0.05*y[21] + 1)**2 + 0.023*y[12]/(y[21] + 20.0) - 0.9*y[16]*y[21]/(y[21] + 200)**2 + 0.9*y[16]/(y[21] + 200);
}
...
double J_24_24 (double y[34]) {
    return 4.53228915615779e-5*y[14]*y[24]/(0.0139470013947001*y[24] + 1)**2 - 0.233*y[14]/(y[24] + 71.7) - 153.9*y[18];
}
...
double J_24_25 (double y[34]) {
    return -4.53228915615779e-5*y[14]*y[24]/(0.0139470013947001*y[24] + 1)**2 + 0.233*y[14]/(y[24] + 71.7);
}
...
double J_26_26 (double y[34]) {
    return 4.47393350178666e-5*y[16]*y[26]/(0.0139470013947001*y[26] + 1)**2 - 0.23*y[16]/(y[26] + 71.7);
}
...
double J_29_29 (double y[34]) {
    return 5.90850825188271e-6*y[14]*y[29]/(0.000316455696202532*y[29] + 1)**2 - 59.0*y[14]/(y[29] + 3160.0);
}
